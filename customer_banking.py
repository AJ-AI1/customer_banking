...
def main():
    ...
    # ADD YOUR CODE HERE
    savings_balance = float(input("Input your saving balance "))
    savings_interest = float(input("Input your interest rate "))
    savings_maturity = int(input("Input the lenght of months for your savings account "))
    ...
    print(f"Updated savings account: ${updated_savings_balance:.2f}")
